...
Free(HeapType heapType, void* ptr)
{
    ...
    if (0 != ptr)
    {
        ...
        #endif // __XBOX360__
        {
            ...
            if (MemoryLoggingEnabled&& (size >= MemoryLoggingThreshold))
            {
                n_printf("Mem::Free(heapType=%d, ptr=0x%lx)\n", heapType, ptr);
            }
        #endif
    }
}
...
*/
void
EnableMemoryLogging(unsigned int threshold)
{
...
*/
void
ToggleMemoryLogging(unsigned int threshold)
{
