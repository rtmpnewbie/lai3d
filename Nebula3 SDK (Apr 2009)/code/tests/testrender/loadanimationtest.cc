...
LoadAnimationTest::Run()
{
    if (this->SetupRuntime())
    {
        ...
        Ptr<AnimResource> anim0 = this->resServer->CreateSharedResource(animName, AnimResource::RTTI, (ResourceLoader*) StreamAnimationLoader::Create()).downcast<AnimResource>();
        ...
        anim0 = this->resServer->CreateSharedResource(animName, AnimResource::RTTI, (ResourceLoader*) StreamAnimationLoader::Create()).downcast<AnimResource>();
        n_assert(anim0.isvalid());
        this->Verify(this->resServer->HasSharedResource(animName));
