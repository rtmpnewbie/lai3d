...
LoadTextureTest::Run()
{
    ...
    if (this->SetupRuntime())
    {
        ...
        Ptr<Texture> tex0 = this->resServer->CreateSharedResource(tex1Name, Texture::RTTI, (ResourceLoader*) StreamTextureLoader::Create()).downcast<Texture>();
        ...
        Ptr<Texture> tex1 = this->resServer->CreateSharedResource(tex2Name, Texture::RTTI, (ResourceLoader*) StreamTextureLoader::Create()).downcast<Texture>();
