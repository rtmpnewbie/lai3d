...
*/
void
SUIRenderModule::ShowLayout(const StringAtom& layoutId)
{
    n_assert(this->IsValid());
...
*/
bool
SUIRenderModule::HasEventOccured(const SUIEvent& suiEvent)
{
    return (InvalidIndex != this->suiEvents.FindIndex(suiEvent));
}
