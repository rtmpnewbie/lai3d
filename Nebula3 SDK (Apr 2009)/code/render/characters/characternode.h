...
public:
    ...
    virtual Ptr<Models::ModelNodeInstance> CreateNodeInstanceHierarchy(const Ptr<Models::ModelInstance>& modelInst, const Ptr<Models::ModelNodeInstance>& parentNodeInst=0);
...
private:
    ...
    Util::Array<Util::StringAtom> clipNames;
};
