...
XInputGamePad::OnAttach()
{
    ...
    // UPDATE: now no seperate timer is used, we use our MasterTime 
    this->lastCheckConnectedTime = Timing::MasterTime::Instance()->GetTicks() - CheckConnectedInterval;
}
...
XInputGamePad::OnBeginFrame()
{
    ...
    Timing::Tick curTime = Timing::MasterTime::Instance()->GetTicks();
