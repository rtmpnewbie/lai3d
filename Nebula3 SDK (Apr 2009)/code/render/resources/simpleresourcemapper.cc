...
*/
Ptr<ManagedResource>
SimpleResourceMapper::OnCreateManagedResource(const Rtti& resType, const ResourceId& resId, const Ptr<ResourceLoader>& optResourceLoader)
{
    ...
    {
        // an optional resource loader object has been provided
        resource = sharedServ->CreateSharedResource(resId, *(this->resourceClass), optResourceLoader);
    }
    else
    {
        // no optional resource loader has been provided, create one
        resource = sharedServ->CreateSharedResource(resId, *(this->resourceClass), (ResourceLoader*) this->resLoaderClass->Create());
    }
