...
DisplayPageHandler::WriteScreenshot(const String& fileFormat, const Ptr<Stream>& responseContentStream)
{
    ...
    ImageFileFormat::Code actualFmt = RenderDevice::Instance()->SaveScreenshot(fmt, responseContentStream);
    responseContentStream->SetMediaType(ImageFileFormat::ToMediaType(actualFmt));
