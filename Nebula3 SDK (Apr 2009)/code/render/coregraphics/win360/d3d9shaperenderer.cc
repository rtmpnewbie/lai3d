...
D3D9ShapeRenderer::Open()
{
    ...
    n_assert(0 != d3d9Dev);
    hr = D3DXCreateBox(d3d9Dev, 1.0f, 1.0f, 1.0f, &this->shapeMeshes[RenderShape::Box], NULL);
    ...
    n_assert(SUCCEEDED(hr));
    hr = D3DXCreateTorus(d3d9Dev, 1.0f, 1.0f, 10, 10, &this->shapeMeshes[RenderShape::Torus], NULL);
    n_assert(SUCCEEDED(hr));
