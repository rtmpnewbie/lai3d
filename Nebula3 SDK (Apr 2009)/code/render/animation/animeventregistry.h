...
//------------------------------------------------------------------------------
/**
    @class Animation::AnimEventRegistry
...
namespace Attr
{
    ...
    // cam shake stuff
    DeclareFloat(Intensity, 'aein', ReadOnly);
    DeclareFloat(Range, 'aera', ReadOnly);

    // sound stuff
    DeclareString(CueName, 'aecn', ReadOnly);
...
public:
    ...
    /// return requested event
    const Util::StringAtom& GetSoundEvent(const Util::StringAtom& eventName) const;
    /// return requested event
...
private:
    ...
    Util::Dictionary<Util::StringAtom, Util::StringAtom> animEventSounds;
