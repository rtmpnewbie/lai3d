...
namespace Attr
{
    DefineString(Behaviour, 'BEHV', ReadWrite);
}
...
Timing::Time BehaviourProperty::updateTime = 0.5;
//------------------------------------------------------------------------------
/**
*/
void
...
*/
void
BehaviourProperty::SetupDefaultAttributes()
{
    Property::SetupDefaultAttributes();
    this->entity->AddString(Attr::Behaviour);  
}
