...
public:
    ...
    virtual Ptr<Game::Entity> CreateEntityByCategory(const Util::String& categoryName, const Ptr<Db::ValueTable>& attrTable, IndexT attrTableRowIndex) const;
    /// create a new entity from scratch and initialize it with the provided attributes
    virtual Ptr<Game::Entity> CreateEntityByAttrs(const Util::String& categoryName, const Util::Array<Attr::Attribute>& attrs) const;;
    /// create a new entity from a database template entry
    virtual Ptr<Game::Entity> CreateEntityByTemplate(const Util::String& categoryName, const Util::String& templateName) const;
