#ifndef PROPERTIES_STATEPROPERTY_H
#define PROPERTIES_STATEPROPERTY_H
//------------------------------------------------------------------------------
/**
...
namespace Attr
{
    DeclareString(State, 'STAT', ReadWrite);
    DeclareMatrix44(StateBaseTransform, 'STBT', ReadWrite);
    DeclareBool(StateBaseTransformSet, 'SBTS', ReadWrite);
    DeclareString(StateFilename, 'STFN', ReadWrite);
};
