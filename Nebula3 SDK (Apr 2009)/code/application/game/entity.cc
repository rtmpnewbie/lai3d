...
Entity::ActivateProperties()
{
    ...
    for (i = 0; i < num; i++)
    {
        ...
        this->isInSetupDefaultAttrs = true;
        prop->SetupDefaultAttributes();
        this->isInSetupDefaultAttrs = false;
#if NEBULA3_ENABLE_PROFILING
...
Entity::AddBool(const Attr::BoolAttrId& attrId)
{
    ...
    {
        CategoryManager::Instance()->AddCategoryAttr(attrId);
    }
}
...
{
    n_assert(!this->isInSetupDefaultAttrs);
