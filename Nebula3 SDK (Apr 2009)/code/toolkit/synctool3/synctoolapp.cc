...
SyncToolApp::ParseCmdLineArgs()
{
    if (ToolkitApp::ParseCmdLineArgs())
    {
        ...
        if ((0 == this->opMask) || this->args.GetBoolFlag("-all"))
        {
            ...
            this->opMask = OpUpdate | OpSync | OpExport;
        }
...
SyncToolApp::SetupProjectInfo()
{
    if (ToolkitApp::SetupProjectInfo())
    {
        ...
        this->rcsWrapper.SetSVNToolLocation(this->projectInfo.GetAttr("SVNToolPath"));
        ...
        this->gfxBatchTool = this->projectInfo.GetAttr("SyncGfxBatchTool");
        this->gfxBatchArgs = this->projectInfo.GetAttr("SyncGfxBatchArgs");
        this->texBatchTool = this->projectInfo.GetAttr("SyncTexBatchTool");
