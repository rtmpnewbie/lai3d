...
ActorPhysicsProperty::SetupDefaultAttributes()
{
    ...
    this->entity->AddFloat4(Attr::VelocityVector);
    this->entity->AddFloat(Attr::RelVelocity);
    this->entity->AddFloat(Attr::MaxVelocity);
    this->entity->AddBool(Attr::Following);
    this->entity->AddBool(Attr::Moving);
    this->entity->AddInt(Attr::TargetEntityId);
}
...
ActorPhysicsProperty::HandleMoveRotate(MoveRotate* msg)
{
    ...
    direction = vector::transform(direction, matrix44::rotationy(angle));
