...
{
    this->entity->AddFloat(Attr::Saturation);
    this->entity->AddFloat4(Attr::Balance);
    this->entity->AddFloat(Attr::BloomScale);
    this->entity->AddFloat4(Attr::BloomColor);
    this->entity->AddFloat(Attr::BrightPassThreshold);
    this->entity->AddFloat(Attr::FogNearDist);
    this->entity->AddFloat(Attr::FogFarDist);
    this->entity->AddFloat(Attr::FogHeight);
    this->entity->AddFloat(Attr::FocusDist);
    this->entity->AddFloat(Attr::FocusLength);
    this->entity->AddFloat(Attr::SkyContrast);
    this->entity->AddFloat(Attr::SkyBrightness);
    this->entity->AddFloat(Attr::LightIntensity);
    ...
    this->entity->AddFloat(Attr::BackLightFactor);
    this->entity->AddFloat(Attr::LightShadowIntensity);
    this->entity->AddFloat4(Attr::FogColor);
    this->entity->AddFloat(Attr::FogIntensity);
}
...
AmbienceBubbleProperty::HandleMessage(const Ptr<Messaging::Message>& msg)
{
  ...
  //  {
		//if(this->GetEntity()->GetEntityPool() == Game::Entity::LivePool)
		//{
		//	// this is usually coming only from the level editor
		//	if(this->postEffectEntity.isvalid())
		//	{
		//		this->postEffectEntity->SetFadeTime(this->entity->GetFloat(Attr::PEFadeTime));
		//	}
		//	this->UpdatePostEffectEntityFromAttrs();
		//}
  //  }
