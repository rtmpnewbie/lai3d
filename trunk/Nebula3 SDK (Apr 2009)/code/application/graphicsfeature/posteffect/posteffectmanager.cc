...
PostEffectManager::OnActivate()
{
    ...
    // start up post effect sytem in render thread
    Ptr<PostEffect::SetupPostEffectSystem> setupPosteffectSystem = PostEffect::SetupPostEffectSystem::Create();
    Graphics::GraphicsInterface::Instance()->SendBatched(setupPosteffectSystem.cast<Messaging::Message>());
