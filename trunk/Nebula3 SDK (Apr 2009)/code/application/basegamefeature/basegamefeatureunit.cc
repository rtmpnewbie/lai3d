...
BaseGameFeatureUnit::OnActivate()
{
    ...
    this->audioPlayer = Audio::AudioPlayer::Create();

    // create audio interface
    this->audioInterface = Audio::AudioInterface::Create();
    ...
    if (!Animation::AnimEventRegistry::HasInstance())
    {
        this->animEventRegistry = Animation::AnimEventRegistry::Create();
