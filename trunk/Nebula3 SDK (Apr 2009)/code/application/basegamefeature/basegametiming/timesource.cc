...
namespace Attr
{
    DefineString(TimeSourceId, 'TIID', ReadWrite);
    DefineFloat(TimeSourceTime, 'TIST', ReadWrite);
    DefineFloatWithDefault(TimeSourceFactor, 'TIFA', ReadWrite, 1.0f);
    DefineInt(TimeSourceFrameId, 'TFID', ReadWrite);
};
