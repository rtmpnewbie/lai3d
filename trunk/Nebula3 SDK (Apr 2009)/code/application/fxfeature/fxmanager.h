...
/**
    ...
    This manager is the client frontend for the CoreFX::FxServer on the render
    thread site. Handle all communication to the CoreFX subsystem through this
    manager!
...
public:
    ...
    /// create shake effect
    void EmitCameraShakeEffect( float intensity,
