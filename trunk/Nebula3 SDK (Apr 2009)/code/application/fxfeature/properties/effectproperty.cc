...
//------------------------------------------------------------------------------
#include "stdneb.h"
#include "fxfeature/properties/effectproperty.h"
...
EffectProperty::EmitAttachmentEvent(const Util::StringAtom& eventName) const
{
    ...
    //const Animation::AnimEventRegistry::AttachmentEvent& event = AnimEventRegistry::Instance()->GetAttachmentEvent(eventName);
...
EffectProperty::EmitCameraShakeEvent(const Util::StringAtom& eventName) const
{
    ...
    const Animation::AnimEventRegistry::ShakeEvent& event = AnimEventRegistry::Instance()->GetCamShakeEvent(eventName);
...
EffectProperty::EmitSoundEvent(const Util::StringAtom& eventName) const
{
    ...
    const Util::StringAtom& soundName = AnimEventRegistry::Instance()->GetSoundEvent(eventName);

    // emit
    Audio::AudioPlayer::Instance()->PlayCue3D(CoreAudio::CueId(soundName), this->GetEntity()->GetMatrix44(Attr::Transform), Math::vector::nullvec());
}
...
EffectProperty::EmitTimingEvent(const Util::StringAtom &eventName) const
{
    ...
    const Animation::AnimEventRegistry::TimingEvent& event = AnimEventRegistry::Instance()->GetTimingEvent(eventName);
...
EffectProperty::EmitVibrationEvent(const Util::StringAtom& eventName, IndexT playerIndex) const
{
    ...
    const Animation::AnimEventRegistry::VibrationEvent& event = AnimEventRegistry::Instance()->GetVibrationEvent(eventName);
