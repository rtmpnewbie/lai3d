#pragma once
#ifndef ANIMATION_ANIMEVENTHANDLERBASE_H
#define ANIMATION_ANIMEVENTHANDLERBASE_H
//------------------------------------------------------------------------------
/**
    ...
    Create this ín Main application and register it via RegisterAnimEventHandler
...
namespace Animation
{
class AnimEventHandlerBase : public Core::RefCounted
{
