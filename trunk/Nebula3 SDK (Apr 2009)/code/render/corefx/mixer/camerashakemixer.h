...
namespace CoreFX
{
class CameraShakeMixer : public CoreFX::EffectMixer
{
...
private:
    ...
    float ComputeShakeIntensityAtPosition(const Util::Array<Ptr<Effect> >& effects, const Math::vector& pos) const;
