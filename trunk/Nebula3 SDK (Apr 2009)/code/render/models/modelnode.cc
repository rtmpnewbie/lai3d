...
*/
Ptr<ModelNodeInstance>
ModelNode::CreateNodeInstanceHierarchy(const Ptr<ModelInstance>& modelInst, const Ptr<ModelNodeInstance>& parentNodeInst)
{
    ...
    {
        this->children[i]->CreateNodeInstanceHierarchy(modelInst, myNodeInst);
    }
    return myNodeInst;
}
