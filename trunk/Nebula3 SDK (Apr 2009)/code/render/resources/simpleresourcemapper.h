#pragma once
#ifndef RESOURCES_SIMPLERESOURCEMAPPER_H
#define RESOURCES_SIMPLERESOURCEMAPPER_H
//------------------------------------------------------------------------------
/**
...
public:
    ...
    virtual Ptr<ManagedResource> OnCreateManagedResource(const Core::Rtti& resType, const ResourceId& resId, const Ptr<ResourceLoader>& optResourceLoader=0);
