...
D3D9RenderTarget::Setup()
{
    ...
    {
        Resources::ResourceId resolveCPUTextureResId = Util::String(this->resolveTextureResId.Value() + "_CPU_ReadOnly");
        this->resolveCPUTexture = SharedResourceServer::Instance()->CreateSharedResource(resolveCPUTextureResId, Texture::RTTI).downcast<Texture>();
