...
public:
    ...
    ~CharacterJoint();
    /// setup the joint
    void Setup(IndexT parentJointIndex, const CharacterJoint* parentJoint, const Math::vector& poseTranslation, const Math::quaternion& poseRotation, const Math::vector& poseScale, const Util::StringAtom& name);
