    ...
    if (htmlWriter->Open())
    {
        ...
        htmlWriter->Begin(HtmlElement::Table);
            htmlWriter->Begin(HtmlElement::TableRow); 
                ...
                htmlWriter->Element(HtmlElement::TableData, companyName.Value().AsCharPtr());
            htmlWriter->End(HtmlElement::TableRow);
            htmlWriter->Begin(HtmlElement::TableRow); 
                htmlWriter->Element(HtmlElement::TableData, "Application Name:");
                htmlWriter->Element(HtmlElement::TableData, appName.Value().AsCharPtr());
            htmlWriter->End(HtmlElement::TableRow);
            htmlWriter->Begin(HtmlElement::TableRow); 
                htmlWriter->Element(HtmlElement::TableData, "Root Directory:");
                htmlWriter->Element(HtmlElement::TableData, rootDir.Value().AsCharPtr());        
            htmlWriter->End(HtmlElement::TableRow);
            htmlWriter->Begin(HtmlElement::TableRow); 
